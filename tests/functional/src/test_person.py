...
@pytest.mark.asyncio
async def test_get_all_persons(prepare_data, make_get_request, get_all_data_elastic):
    """Вывести всех персон"""
...
@pytest.mark.asyncio
async def test_search_detailed(prepare_data, make_get_request):
    ...
    assert response.body == prepare_data


@pytest.mark.asyncio
async def test_get_by_id(prepare_data, make_get_request):
...
@pytest.mark.asyncio
async def test_get_films_by_peson_id(prepare_data, prepare_es_film, make_get_request):
